from practice_2.practice_2_3.practice_2_3_1 import generate_initial_q_value, generate_initial_random_policy, \
    print_optimal_policy
from practice_2_3_cliff_utils import CliffGridWorld
import numpy as np
